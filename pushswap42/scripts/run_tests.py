...
class Test_500(unittest.TestCase):
	...
	def test_1_1(self):
		proc = Popen('cat result1.txt | ./repo/push_swap/checker "$(< test1.tst)"', shell=True, stdout=PIPE)
		re = proc.stdout.read()
		self.assertEqual("OK\n", re)
	...
	def test_2_1(self):
		proc = Popen('cat result2.txt | ./repo/push_swap/checker "$(< test2.tst)"', shell=True, stdout=PIPE)
		re = proc.stdout.read()
		self.assertEqual("OK\n", re)
	...
	def test_3_1(self):
		proc = Popen('cat result3.txt | ./repo/push_swap/checker "$(< test3.tst)"', shell=True, stdout=PIPE)
		re = proc.stdout.read()
		self.assertEqual("OK\n", re)
	...
	def test_4_1(self):
		proc = Popen('cat result4.txt | ./repo/push_swap/checker "$(< test4.tst)"', shell=True, stdout=PIPE)
		re = proc.stdout.read()
		self.assertEqual("OK\n", re)
	...
	def test_5_1(self):
		proc = Popen('cat result5.txt | ./repo/push_swap/checker "$(< test5.tst)"', shell=True, stdout=PIPE)
		re = proc.stdout.read()
		self.assertEqual("OK\n", re)
